...
> **Status:** plano para revisão. Não executar antes da autorização explícita do usuário. Spec e plano são mantidos em docs/superpowers/ no repositório principal; o worktree será usado apenas na etapa de implementação.
