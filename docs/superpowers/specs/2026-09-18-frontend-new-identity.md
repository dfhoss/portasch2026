...
Data: 2026-09-18. Status: proposta aguardando revisão do usuário; implementação não autorizada nesta etapa. Escopo proposto: aplicar DESIGN.new.md ao frontend atual, usar os banners fornecidos para desktop/celular, renomear assets; executar com worktree, TDD e SDD.
